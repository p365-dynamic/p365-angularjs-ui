...
angular
    ...
    function ($routeProvider) {
      $routeProvider
        .when("/", {
          ...
          templateUrl: wp_path + "buy/landing-page/landingPage.html",
        })
        .when("/quote", {
        ...
        .when("/PBQuote", {
          controller: "quoteController",
          templateUrl:
            wp_path + "buy/common/html/PBHTML/PBGetQuoteTemplate.html",
        })
        .when("/accessDenied", {
          controller: "",
        ...
        .when("/criticalIllnessInstantQuote", {
          ...
          templateUrl:
            wp_path +
            "buy/criticalIllness/html/CriticalIllnessInstantQuote.html",
        })
        .when("/personalAccidentInstantQuote", {
          controller: "personalAccidentInstantQuoteController",
          templateUrl:
            wp_path +
            "buy/personalAccident/html/PersonalAccidentInstantQuote.html",
        })
        ...
        .when("/criticalIllnessResult", {
          ...
          templateUrl:
            wp_path + "buy/criticalIllness/html/CriticalIllnessResult.html",
        })
        .when("/personalAccidentResult", {
          controller: "personalAccidentResultController",
          templateUrl:
            wp_path + "buy/personalAccident/html/PersonalAccidentResult.html",
        })
        .when("/homeResult", {
        ...
        .when("/buyPersonalAccident", {
          ...
          templateUrl:
            wp_path +
            "buy/personalAccident/html/PersonalAccidentBuyProduct.html",
        })
        .when("/buyFourWheeler", {
        ...
        .when("/FourWheelerscheduleInspection", {
          ...
          templateUrl:
            wp_path + "buy/car/html/FourWheelerscheduleInspection.html",
        })
        .when("/buyTwoWheeler", {
        ...
        .when("/paysuccesspersonalaccident", {
          ...
          templateUrl:
            wp_path +
            "buy/personalAccident/html/PersonalAccidentPaySuccess.html",
        })
        ...
        .when("/payfailurepersonalaccident", {
          ...
          templateUrl:
            wp_path +
            "buy/personalAccident/html/PersonalAccidentPayFailure.html",
        })
        ...
        .when("/professionalJourneyResult", {
          ...
          templateUrl:
            wp_path + "buy/common/html/professionalJourneyResult.html",
        })
        .when("/PBCarResult", {
          controller: "carResultController",
        ...
        .when("/lifePurchasing", {
          ...
          templateUrl:
            wp_path + "buy/life/html/AssurancePurchasingStatement.html",
        })
  ...
  .run([
    ...
    function ($rootScope, $location, $cookieStore, $http, $mdDialog) {
        ...
        if (customEnvEnabled || wordPressEnabled) {
          if (wordPressEnabled) {
            if (
              ...
              urlPattern != "/medicalPurchasing" &&
              urlPattern != "/carpolicypurchase" &&
              urlPattern != "/bikepolicypurchase" &&
              urlPattern != "/lifePurchasing" &&
              urlPattern != "/claims" &&
              urlPattern != "/travelpolicypurchase"
            ) {
              ...
              // }
                ...
                !p365Includes(paymentPageUrls, urlPattern)
              ) {
                ...
                !p365Includes(carPageUrls, urlPattern)
              ) {
                $rootScope.isCarProductTabClicked = true;
                $rootScope.reloadStatus = true;
                ...
                !p365Includes(bikePageUrls, urlPattern)
              ) {
                ...
                !p365Includes(healthPageUrls, urlPattern)
              ) {
                ...
                window.location.href.indexOf("term/") > -1 &&
                !p365Includes(lifePageUrls, urlPattern)
              ) {
                ...
                !p365Includes(travelPageUrls, urlPattern)
              ) {
                $rootScope.isTravelProductTabClicked = true;
                $rootScope.reloadStatus = true;
                $location.path("/PBQuote");
              } else if (
                window.location.href.indexOf("criticalillness/") > -1 &&
                !p365Includes(criticalIllnessPageUrls, urlPattern)
              ) {
                $rootScope.isCriticalIllnessProductTabClicked = true;
                $rootScope.reloadStatus = true;
                $location.path("/PBQuote");
              } else if (
                window.location.href.indexOf("shareprofile/") > -1 &&
                !p365Includes(professionalPageUrls, urlPattern) &&
                !p365Includes(travelPageUrls, urlPattern) &&
                !p365Includes(lifePageUrls, urlPattern) &&
                !p365Includes(healthPageUrls, urlPattern) &&
                !p365Includes(bikePageUrls, urlPattern) &&
                ...
                $rootScope.reloadStatus = true;
                console.log(
                  "condition for professional Share API in layoutManager is working"
                );
                $location.path("/professionalShareAPI");
              } else if (
                window.location.href.indexOf("sharequote/") > -1 &&
                !p365Includes(travelPageUrls, urlPattern) &&
                !p365Includes(lifePageUrls, urlPattern) &&
                !p365Includes(healthPageUrls, urlPattern) &&
                !p365Includes(bikePageUrls, urlPattern) &&
                ...
                $rootScope.reloadStatus = true;
                console.log(
                  "condition for quote Share API in layoutManager is working"
                );
                $location.path("/sharefromAPI");
              } else if (
                window.location.href.indexOf("ipos/") > -1 &&
                !p365Includes(proposalPageUrls, urlPattern) &&
                !p365Includes(travelPageUrls, urlPattern) &&
                !p365Includes(lifePageUrls, urlPattern) &&
                !p365Includes(healthPageUrls, urlPattern) &&
                !p365Includes(bikePageUrls, urlPattern) &&
          ...
          if (
            urlPattern != "/critical-illness" &&
            urlPattern != "/healthLanding" &&
            urlPattern != "/lifeLanding" &&
            urlPattern != "/personal-accident" &&
            urlPattern != "/claims" &&
            urlPattern != "/logout" &&
            urlPattern != "/contact" &&
            urlPattern != "/signIn" &&
            ...
            urlPattern.indexOf("professionalShareAPI") == -1 &&
            urlPattern.indexOf("sharefromAPI") == -1 &&
            urlPattern.indexOf("ipos") == -1 &&
            p365Includes(productPageUrls, urlPattern) == false &&
            !$rootScope.reloadStatus
          ) {
          ...
          if (
            ...
            urlPattern.indexOf("professionalShareAPI") == -1 &&
            urlPattern.indexOf("sharefromAPI") == -1 &&
            urlPattern.indexOf("dcpResult") == -1 &&
            urlPattern.indexOf("ipos") == -1 &&
            urlPattern.indexOf("iquoteNavigation") == -1 &&
            !$rootScope.reloadStatus
          ) {
            $rootScope.landingFlag = false;
      ...
      $rootScope.P365Confirm = function (
        dialogTitle,
        dialogBody,
        submitButtonCaption,
        cancelButtonCaption,
  ...
  .directive("resetDirective", [
    ...
    function ($parse) {
      return function (scope, element, attr) {
        ...
        if (!fn.assign) {
          throw Error(
            "Expression is required to be a model: " + attr.resetDirective
          );
        }
    ...
    return {
      ...
      link: function (scope, element, attrs) {
        element.find(".accordion-toggle").click(function () {
          ...
          $(".accordion-content")
            .not($(this).next())
            .slideUp(scope.slideUpSpeed, scope.slideUpEasing);
        });
      },
    };
  })
  ...
  .directive("modalDialog", function () {
    return {
      ...
      template:
        "<div class='ng-modal' ng-show='show'> <div class='ng-modal-overlay' ng-click=''></div><div class='ng-modal-dialog wp_modelDialog' ng-style='dialogStyle'><div class='ng-modal-dialog-content' ng-transclude></div></div></div>",
    };
  })
  .directive("counter", function () {
    return {
      ...
      link: function (scope, element, attributes) {
        ...
        var min = angular.isUndefined(attributes.min)
          ? null
          : parseInt(attributes.min);
        var max = angular.isUndefined(attributes.max)
          ? null
          : parseInt(attributes.max);
        var step = angular.isUndefined(attributes.step)
          ? 1
          : parseInt(attributes.step);
        element.addClass("counter-container");
        // If the 'editable' attribute is set, we will make the field editable.
        scope.readonly = angular.isUndefined(attributes.editable)
          ? true
          : false;
        /**
        ...
        scope.minus = function () {
          if (
            (min && (scope.value <= min || scope.value - step <= min)) ||
            (min === 0 && scope.value < 1)
          ) {
            setValue(min);
            return false;
  ...
  .directive("loading", function () {
    return {
      ...
      template:
        "<div  class='loading'><div class='loaderPlacer'><div class='spinner'><div class='rect1'></div><div class='rect2'></div><div class='rect3'></div><div class='rect4'></div><div class='rect5'></div></div></div></div>",
      link: function (scope, element, attr) {
  ...
  .directive("p365Chart", function () {
    return {
      ...
      template:
        "<div id='ChartContainer' style='margin: 0 auto'>not working</div>",
      link: function (scope, element, attrs) {
        ...
        var chart = Highcharts.chart(element[0], {
          ...
          tooltip: {
            ...
            formatter: function () {
              return (
                "Sum Insured :<b>&#8377;&nbsp;" + this.point.ammount + "<b>"
              );
            },
          },
          xAxis: {
  ...
  .directive("p365PieChart", function () {
    return {
      ...
      controller: function ($scope, $element, $attrs) {},
      template:
        "<div class='PieChartContainer' style='margin: 0 auto'>not working</div>",
      link: function (scope, element, attrs) {
        var themeColors = new Array(scope.items.length);
        var highRiskCount = 0;
          ...
          plotOptions: {
            pie: {
              ...
              dataLabels: {
                ...
                // }
                format:
                  '<span style="font-size:10px;">{point.name}: <span style="color:{point.color}">{point.riskPriority}</span></span>',
              },
