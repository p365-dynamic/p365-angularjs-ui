    ...
    module.directive('nzTour', ["$q", "$compile", function($q, $compile) {
        return {
            template: [
                ...
                '        </div>',
                '        <div id="nzTour-actions"><div flex="100" layout="row">',
                '            <div flex="50" style="padding:0px 2px" ng-show="view.step > 0 && view.showPrevious"><button id="nzTour-previous" ng-click="previous()" class="PB_QuoteBackBtn" style="width:100% !important;padding:0 7px;    "><<</button></div>',
                '            <div flex="100" style="padding:0px 2px" ng-show="view.step >= 0 && view.showNext"><button id="nzTour-next"  ng-click="next()" class="PB_QuoteSaveBtn"  style="width:100% !important;padding:0 7px;">{{view.nextText}}</button></div>',
                '        </div></div>',
                '    </div>',
                '</div>',
