'use strict';
angular.module('fourWheelerPolicyPurchase', ['LocalStorageModule']) 
.controller('fourWheelerPolicyPurchaseController', ['$scope', 'localStorageService', function ($scope, localStorageService){
